  ...
  <div class="mt-8">
    <form @submit.prevent="handleSubmit">
      ...
      <button
        ...
        class="px-8 py-2 mt-10 text-2xl font-bold text-white rounded-full bg-brand-main
          focus:outline-none trasition-all duration-150"
      >
...
export default {
  ...
  setup () {
    ...
    } = useField('password', validateEmptyAndLength(3))

    const {
      value: nameValue,
      errorMessage: nameErrorMessage
    } = useField('name', validateEmptyAndLength(6))
